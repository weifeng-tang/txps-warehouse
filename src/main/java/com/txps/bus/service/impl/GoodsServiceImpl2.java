...
@Service
@Transactional
public class GoodsServiceImpl2 extends ServiceImpl<GoodsMapper2, Goods2> implements IGoodsService2 {

    @Override
    public boolean save(Goods2 entity) {
        return super.save(entity);
    }

    @Override
    public boolean updateById(Goods2 entity) {
    ...
    @Override
    public Goods2 getById(Serializable id) {
     ...
     */
    @Override
    public List<Goods2> loadAllWarning() {
        List<Goods2> goods = baseMapper.loadAllWarning();
        return goods;
    }
}
